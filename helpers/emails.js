  ...
  try {
    await resend.emails.send({
      ...
      html: `
        ...
        <a href="${process.env.BACKEND_URL}/out/confirmar-cuenta/${token}">Confirma tu cuenta</a> </p>
  ...
  try {
    await resend.emails.send({
      ...
      html: `
        ...
        <a href="${process.env.BACKEND_URL}/out/olvide-password/${token}">Reestablecer Password</a> </p>
